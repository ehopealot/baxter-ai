...
- Reply by piping your response text to `node {{MAIL_CLI_PATH}} reply {{MESSAGE_ID}}` (reads the body from stdin). This replies specifically to the marked message above.

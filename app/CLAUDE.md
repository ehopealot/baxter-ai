...
- **Proactive date follow-ups** (`scripts/followup-*.ts`) — origin-bound Mail/SMS/Home Chat creation, bounded candidates, strict tool-less firing, and send/cancel linearization. See [proactive follow-ups](docs/architecture/proactive-followups.md).

...
test("resend + chat sdk + micromark deps present and exact-pinned", () => {
  const deps = { ...pkg.dependencies };
  for (const name of ["chat", "@resend/chat-sdk-adapter", "@chat-adapter/shared", "resend", "better-sqlite3", "micromark"]) {

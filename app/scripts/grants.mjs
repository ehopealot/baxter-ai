...
const CORE_TOOLS =
  "Bash(code-cli *) Bash(files-cli *) Bash(projects-cli *) Bash(data-cli *) Bash(web-cli *) Bash(playwright-cli *) Bash(invisible-cli *) WebSearch WebFetch Skill Read Write Edit";
...
const MAIL_SKILL_NAMES = ["playwright-cli", "invisible-playwright", "code", "schedule", "web", "projects", "data"];
const DISCORD_SKILL_NAMES = ["playwright-cli", "invisible-playwright", "discord", "code", "schedule", "web", "projects", "data"];
...
const HEARTBEAT_SKILL_NAMES = ["playwright-cli", "invisible-playwright", "discord", "code", "web", "projects", "data"];

...
// poll.ts does the I/O around these -- minting each attachment's presigned downloadUrl via
// `mail.ts get-attachment`, then setting BAXTER_MEDIA / BAXTER_MODEL_OVERRIDE on the run --
...
// forward (a .zip, or video over email). "" when there are none. The caller (poll.ts)

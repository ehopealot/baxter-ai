...
const CORE_TOOLS =
  "Bash(code-cli *) Bash(files-cli *) Bash(projects-cli *) Bash(memory-cli *) Bash(calendar-cli *) Bash(checklist-cli *) Bash(data-cli *) Bash(skills-cli *) Bash(web-cli *) Bash(playwright-cli *) Bash(invisible-cli *) WebSearch WebFetch Skill Read Write Edit";
...
export const SKILL_NAMES = ["playwright-cli", "invisible-playwright", "discord", "code", "schedule", "web", "projects", "memory", "calendar", "checklist", "data", "skill-discovery", "skill-creator", "help-user-setup"];

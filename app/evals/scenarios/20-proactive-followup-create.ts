...
export default {
  ...
  mocks: {
    ...
    "followup-cli": { candidates: "[]", add: JSON.stringify({ id: "f1", subject: "store trip", plan_date: "2026-08-28", next_run_at: "2026-08-27T20:00:00.000Z" }) },
    "sms-cli": { send: JSON.stringify({ sent: true }) },
  },
  expect: [
    calledTool("checklist-cli"),
    calledCliWith("followup-cli", ["candidates", "--plan-date", "2026-08-28"]),

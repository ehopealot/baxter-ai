...
> [Ollama](https://ollama.com) (`qwen2.5:7b` by default; pass any Ollama model as an
> argument, e.g. `baxter shell ollama llama3.2:3b` for a lighter/faster one) and opens the

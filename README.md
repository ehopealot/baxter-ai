...
> [Ollama](https://ollama.com) (`llama3.2:3b` by default; pass any Ollama model as an
> argument, e.g. `baxter shell ollama qwen2.5:7b`) and opens the terminal talking to it —
